...
If these results were not good enough, `stack_blend()` could be called again with different values of `penalty`. As it is, `stack_blend()` picks the penalty parameter with the numerically optimal results. To see the top results: 
