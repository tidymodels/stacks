...
The `add_candidates()` function will add ensemble members to the stack.
...
The `stack_linear` function determines how member model output will ultimately be combined in the final prediction. Now that we know how to combine models, we can fit the models that we know we need.
