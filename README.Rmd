...
Note that a regularized linear model is one of many possible learning algorithms that could be used to fit a stacked ensemble model. For implementations of additional ensemble learning algorithms, see [`h2o::h2o.stackedEnsemble()`](http://docs.h2o.ai/h2o/latest-stable/h2o-r/docs/reference/h2o.stackedEnsemble.html) and [`SuperLearner::SuperLearner()`](https://cran.r-project.org/web/packages/SuperLearner/SuperLearner.pdf).
