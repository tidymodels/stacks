...
```{r class-data-stack, echo = FALSE, out.width = '100%'}
knitr::include_graphics("class_data_stack.png")
```
...
```{r class-model-stack, echo = FALSE, out.width = '100%'}
knitr::include_graphics("class_model_stack.png")
```
