...
Still trying to get a sense for whether this is what `get_all_pred()`s is doing and which of these, if not both, would be part of an implementation. (_All_ of the sub-model results refer to all of the models resulting from the whole grid of proposed hyperparameters?)
