...
```{r, eval = FALSE}
# making workflow_maps from the above objects
reg_wf_map <- workflowsets::workflow_set(
  preproc = list(
    lr = tree_frogs_reg_rec,
    svm = tree_frogs_reg_rec,
    spline = spline_rec
  ),
  models = list(
    lr = lin_reg_spec,
...
usethis::use_data(reg_wf_map, overwrite = TRUE)
